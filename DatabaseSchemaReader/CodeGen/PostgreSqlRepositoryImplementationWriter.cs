...
{
    public class PostgreSqlRepositoryImplementationWriter
    {
        ...
        public PostgreSqlRepositoryImplementationWriter(DatabaseSchema schema, CodeWriterSettings codeWriterSettings, IEnumerable<string> logicalDeleteColumns)
        {
